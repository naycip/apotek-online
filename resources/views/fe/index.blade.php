      ...
      <div class="container position-relative d-flex align-items-center justify-content-between">
        ...
        <nav id="navmenu" class="navmenu d-flex justify-content-between align-items-center">
          ...
          <ul class="d-flex">
            ...
            <li><a href="{{ route('pelanggan.katalog') }}">Katalog Obat</a></li>
          ...
          <ul class="d-flex align-items-center">
            @if(Auth::guard('pelanggan')->check())
              <li>
                <a href="{{ route('pelanggan.dashboard') }}" class="btn btn-primary btn-sm px-3 me-2" style="color: white;">
                  Dashboard ({{ Auth::guard('pelanggan')->user()->nama_pelanggan }})
                </a>
              </li>
              <li>
                <form action="{{ route('pelanggan.logout') }}" method="POST" style="display: inline;">
                    @csrf
            ...
            @else
              <li>
                <a href="{{ route('pelanggan.login') }}" class="btn btn-primary btn-sm px-3" style="color: white;">
                  Sign In / Sign Up
                </a>
              </li>
            @endif
          ...
          <div class="col-lg-6" data-aos="zoom-in" data-aos-delay="100">
            <div class="specialty-card">
              <div class="specialty-content">
                ...
                <a href="{{ route('pelanggan.katalog') }}" class="specialty-link btn btn-primary text-white px-4 py-2 mt-3 rounded-pill">
