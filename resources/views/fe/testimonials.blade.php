...
<head>
  ...
  <link href="{{ asset('{{ asset('assets/vendor/aos/aos.css') }}" rel="stylesheet">
  <link href="{{ asset('{{ asset('assets/vendor/glightbox/css/glightbox.min.css') }}" rel="stylesheet">
  <link href="{{ asset('{{ asset('assets/vendor/fontawesome-free/css/all.min.css') }}" rel="stylesheet">
  <link href="{{ asset('{{ asset('assets/vendor/swiper/swiper-bundle.min.css') }}" rel="stylesheet">
...
<body class="testimonials-page">
    ...
    <div class="branding d-flex align-items-cente">
      ...
      <div class="container position-relative d-flex align-items-center justify-content-between">
        <a href="/index" class="logo d-flex align-items-center">
          ...
          <!-- <img src="{{ asset('{{ asset('assets/img/logo.webp') }}" alt=""> -->
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <div class="profile">
                  <img src="{{ asset('{{ asset('assets/img/person/person-m-9.webp') }}" class="testimonial-img" alt="" loading="lazy">
                  <div class="info">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <div class="profile">
                  <img src="{{ asset('{{ asset('assets/img/person/person-f-5.webp') }}" class="testimonial-img" alt="" loading="lazy">
                  <div class="info">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <div class="profile">
                  <img src="{{ asset('{{ asset('assets/img/person/person-f-12.webp') }}" class="testimonial-img" alt="" loading="lazy">
                  <div class="info">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <div class="profile">
                  <img src="{{ asset('{{ asset('assets/img/person/person-m-12.webp') }}" class="testimonial-img" alt="" loading="lazy">
                  <div class="info">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <div class="profile">
                  <img src="{{ asset('{{ asset('assets/img/person/person-m-13.webp') }}" class="testimonial-img" alt="" loading="lazy">
                  <div class="info">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <p>Texit tempor illum tamen malis malis eram quae irure esse labore quem cillum quid cillum eram malis
                  quorum velit fore eram velit sunt aliqua noster fugiat irure amet legam anim culpa.</p>
                <div class="profile">
                  <img src="{{ asset('{{ asset('assets/img/person/person-f-13.webp') }}" class="testimonial-img" alt="" loading="lazy">
                  <div class="info">
        ...
        <div class="row g-4">
            ...
            <div class="testimonial-item">
              ...
              <div class="testimonial-footer">
                <div class="testimonial-author">
                  <img src="{{ asset('{{ asset('assets/img/person/person-m-3.webp') }}" alt="Author" class="img-fluid rounded-circle"
                    loading="lazy">
                  <div>
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
            <div class="testimonial-item">
              ...
              <div class="testimonial-footer">
                <div class="testimonial-author">
                  <img src="{{ asset('{{ asset('assets/img/person/person-f-5.webp') }}" alt="Author" class="img-fluid rounded-circle"
                    loading="lazy">
                  <div>
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="300">
            <div class="testimonial-item">
              ...
              <div class="testimonial-footer">
                <div class="testimonial-author">
                  <img src="{{ asset('{{ asset('assets/img/person/person-m-7.webp') }}" alt="Author" class="img-fluid rounded-circle"
                    loading="lazy">
                  <div>
                    <h5>David Wilson</h5>
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="400">
            <div class="testimonial-item">
              ...
              <div class="testimonial-footer">
                <div class="testimonial-author">
                  <img src="{{ asset('{{ asset('assets/img/person/person-f-9.webp') }}" alt="Author" class="img-fluid rounded-circle"
                    loading="lazy">
                  <div>
                    <h5>Emily Johnson</h5>
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="500">
            <div class="testimonial-item">
              ...
              <div class="testimonial-footer">
                <div class="testimonial-author">
                  <img src="{{ asset('{{ asset('assets/img/person/person-f-11.webp') }}" alt="Author" class="img-fluid rounded-circle"
                    loading="lazy">
                  <div>
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="600">
            <div class="testimonial-item">
              ...
              <div class="testimonial-footer">
                <div class="testimonial-author">
                  <img src="{{ asset('{{ asset('assets/img/person/person-m-12.webp') }}" alt="Author" class="img-fluid rounded-circle"
                    loading="lazy">
                  <div>
                    <h5>James Taylor</h5>
  ...
  <script src="{{ asset('{{ asset('assets/vendor/aos/aos.js') }}"></script>
  <script src="{{ asset('{{ asset('assets/vendor/glightbox/js/glightbox.min.js') }}"></script>
  <script src="{{ asset('{{ asset('assets/vendor/purecounter/purecounter_vanilla.js') }}"></script>
