        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{ route('user.index') }}" class="nav-item nav-link"><i class="fa fa-users me-2"></i>User</a>
                    <a href="{{ route('jenisobat.index') }}" class="nav-item nav-link active"><i class="fa fa-th me-2"></i>Jenis Obat</a>
                </div>
            </nav>
        </div>
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Edit Jenis Obat: {{ $jenis->jenis }}</h6>
                            
                            <form action="{{ route('jenisobat.update', $jenis->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="deskripsi_jenis" class="form-control" rows="3" required>{{ $jenis->deskripsi_jenis }}</textarea>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    @if($jenis->image_url)
                                        <div class="mt-2">
                                            ...
                                            <img src="{{ asset('storage/jenis_obat/' . $jenis->image_url) }}" width="100px" class="rounded border border-primary">
                                        </div>
                                    @endif
                                </div>
