            ...
            <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <p class="text-center mb-0 mt-3">Bukan Karyawan? <a href="<?php echo e(route('pelanggan.login')); ?>" class="text-primary text-decoration-underline" style="position: relative; z-index: 100;">Login Pelanggan</a></p>
                    </div>
                </div>
            </div>
        </div>
