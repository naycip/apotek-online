                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex gap-1 flex-wrap">
                            <?php if($o->foto1): ?> <img src="<?php echo e(asset('storage/obat/' . $o->foto1)); ?>" alt="Foto 1" style="width: 40px; height: 40px; object-fit: cover; border-radius: 4px;"> <?php endif; ?>
                            <?php if($o->foto2): ?> <img src="<?php echo e(asset('storage/obat/' . $o->foto2)); ?>" alt="Foto 2" style="width: 40px; height: 40px; object-fit: cover; border-radius: 4px;"> <?php endif; ?>
                            <?php if($o->foto3): ?> <img src="<?php echo e(asset('storage/obat/' . $o->foto3)); ?>" alt="Foto 3" style="width: 40px; height: 40px; object-fit: cover; border-radius: 4px;"> <?php endif; ?>
                            <?php if(!$o->foto1 && !$o->foto2 && !$o->foto3): ?>
                                <span class="text-muted small">Tidak ada foto</span>
                            <?php endif; ?>
                        </div>
                    </td>
                    <td><span title="<?php echo e($o->deskripsi_obat); ?>"><?php echo e(\Illuminate\Support\Str::limit($o->deskripsi_obat, 30)); ?></span></td>
                    <td><?php echo e($o->jenis_obat->jenis ?? 'Tidak Ada Jenis'); ?></td> 
