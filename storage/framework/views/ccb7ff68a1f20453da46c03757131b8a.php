      ...
      <div class="container position-relative d-flex align-items-center justify-content-between">
        ...
        <nav id="navmenu" class="navmenu d-flex justify-content-between align-items-center">
          ...
          <ul class="d-flex">
            ...
            <li><a href="<?php echo e(route('pelanggan.katalog')); ?>">Katalog Obat</a></li>
          ...
          <ul class="d-flex align-items-center">
            <?php if(Auth::guard('pelanggan')->check()): ?>
              <li>
                <a href="<?php echo e(route('pelanggan.dashboard')); ?>" class="btn btn-primary btn-sm px-3 me-2" style="color: white;">
                  Dashboard (<?php echo e(Auth::guard('pelanggan')->user()->nama_pelanggan); ?>)
                </a>
              </li>
              <li>
                <form action="<?php echo e(route('pelanggan.logout')); ?>" method="POST" style="display: inline;">
                    <?php echo csrf_field(); ?>
            ...
            <?php else: ?>
              <li>
                <a href="<?php echo e(route('pelanggan.login')); ?>" class="btn btn-primary btn-sm px-3" style="color: white;">
                  Sign In / Sign Up
                </a>
              </li>
            <?php endif; ?>
  ...
  <main class="main">
          ...
          <div class="col-lg-6">
            <div class="hero-visual" data-aos="fade-left" data-aos-delay="400">
              <div class="main-image">
                <img src="<?php echo e(asset('assets/img/health/staff-10.webp')); ?>" alt="Modern Healthcare Facility" class="img-fluid">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-6" data-aos="fade-left" data-aos-delay="300">
            <div class="about-visual">
              <div class="main-image">
                <img src="<?php echo e(asset('assets/img/health/facilities-9.webp')); ?>" alt="Modern medical facility" class="img-fluid">
              </div>
    ...
    <section id="featured-departments" class="featured-departments section">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Layanan Kesehatan Terpadu</h2>
        <p>Kami menyediakan berbagai layanan kesehatan terbaik untuk Anda dan keluarga.</p>
        ...
        <div class="row g-5">
            ...
            <div class="specialty-card">
              <div class="specialty-content">
                <div class="specialty-meta">
                  <span class="specialty-label">Belanja Mudah</span>
                </div>
                <h3>Toko Obat / Apotek</h3>
                <p>Beli obat-obatan bebas, vitamin, suplemen, dan tebus resep dokter dengan mudah secara online. Pengiriman cepat langsung ke rumah Anda.</p>
                <div class="specialty-features">
                  <span><i class="bi bi-check-circle-fill"></i>Produk 100% Asli</span>
                  <span><i class="bi bi-check-circle-fill"></i>Layanan Pengantaran</span>
                </div>
                <a href="<?php echo e(route('pelanggan.katalog')); ?>" class="specialty-link btn btn-primary text-white px-4 py-2 mt-3 rounded-pill">
                  Buka Katalog Obat <i class="bi bi-arrow-right ms-2"></i>
                </a>
              </div>
              <div class="specialty-visual">
                <div style="background: linear-gradient(135deg, #0d6efd, #0dcaf0); height: 100%; display: flex; align-items: center; justify-content: center; border-radius: 0 15px 15px 0;">
                  <i class="fa-solid fa-pills text-white" style="font-size: 6rem;"></i>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-6" data-aos="zoom-in" data-aos-delay="200">
            <div class="specialty-card">
              <div class="specialty-content">
                <div class="specialty-meta">
                  <span class="specialty-label">Konsultasi</span>
                </div>
                <h3>Layanan Konsultasi Dokter</h3>
                <p>Konsultasikan masalah kesehatan Anda dengan dokter-dokter spesialis kami yang berpengalaman, baik secara tatap muka maupun online.</p>
                <div class="specialty-features">
                  <span><i class="bi bi-check-circle-fill"></i>Dokter Spesialis</span>
                  <span><i class="bi bi-check-circle-fill"></i>Jadwal Fleksibel</span>
                </div>
                <a href="/doctors" class="specialty-link btn btn-outline-primary px-4 py-2 mt-3 rounded-pill">
                  Cari Dokter <i class="bi bi-arrow-right ms-2"></i>
                </a>
              </div>
              <div class="specialty-visual">
                <div style="background: linear-gradient(135deg, #198754, #20c997); height: 100%; display: flex; align-items: center; justify-content: center; border-radius: 0 15px 15px 0;">
                  <i class="fa-solid fa-user-doctor text-white" style="font-size: 6rem;"></i>
                </div>
              </div>
            </div>
          </div><!-- End Specialty Card -->
          ...
          <div class="col-lg-8" data-aos="fade-right" data-aos-delay="200">
            <div class="featured-service-main">
              <div class="service-image-wrapper">
                <img src="<?php echo e(asset('assets/img/health/consultation-4.webp')); ?>" alt="Premier Healthcare Services" class="img-fluid"
                  loading="lazy">
        ...
        <div class="specialties-grid" data-aos="fade-up" data-aos-delay="300">
          <div class="row align-items-center">
            ...
            <div class="col-lg-3 col-md-6">
              <div class="specialty-card">
                <div class="specialty-image">
                  <img src="<?php echo e(asset('assets/img/health/maternal-2.webp')); ?>" alt="Maternal Care" class="img-fluid" loading="lazy">
                </div>
                <div class="specialty-content">
                  <h5>Maternal Care</h5>
            ...
            <div class="col-lg-3 col-md-6">
              <div class="specialty-card">
                <div class="specialty-image">
                  <img src="<?php echo e(asset('assets/img/health/vaccination-3.webp')); ?>" alt="Vaccination" class="img-fluid" loading="lazy">
                </div>
                <div class="specialty-content">
                  <h5>Vaccination</h5>
            ...
            <div class="col-lg-3 col-md-6">
              <div class="specialty-card">
                <div class="specialty-image">
                  <img src="<?php echo e(asset('assets/img/health/emergency-1.webp')); ?>" alt="Emergency Care" class="img-fluid" loading="lazy">
                </div>
                <div class="specialty-content">
            ...
            <div class="col-lg-3 col-md-6">
              <div class="specialty-card">
                <div class="specialty-image">
                  <img src="<?php echo e(asset('assets/img/health/facilities-6.webp')); ?>" alt="Advanced Tech" class="img-fluid" loading="lazy">
                </div>
                <div class="specialty-content">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="doctors-grid" data-aos="fade-up" data-aos-delay="300">
          <div class="doctor-profile" data-aos="zoom-in" data-aos-delay="100">
            <div class="profile-header">
              <div class="doctor-avatar">
                <img src="<?php echo e(asset('assets/img/health/staff-2.webp')); ?>" alt="Dr. Amanda Foster" class="img-fluid">
          ...
          <div class="doctor-profile" data-aos="zoom-in" data-aos-delay="200">
            <div class="profile-header">
              <div class="doctor-avatar">
                <img src="<?php echo e(asset('assets/img/health/staff-6.webp')); ?>" alt="Dr. Marcus Johnson" class="img-fluid">
          ...
          <div class="doctor-profile" data-aos="zoom-in" data-aos-delay="300">
            <div class="profile-header">
              <div class="doctor-avatar">
                <img src="<?php echo e(asset('assets/img/health/staff-4.webp')); ?>" alt="Dr. Rachel Williams" class="img-fluid">
                <div class="status-indicator available"></div>
              </div>
              <div class="doctor-details">
          ...
          <div class="doctor-profile" data-aos="zoom-in" data-aos-delay="400">
            <div class="profile-header">
              <div class="doctor-avatar">
                <img src="<?php echo e(asset('assets/img/health/staff-8.webp')); ?>" alt="Dr. David Chen" class="img-fluid">
          ...
          <div class="doctor-profile" data-aos="zoom-in" data-aos-delay="500">
            <div class="profile-header">
              <div class="doctor-avatar">
                <img src="<?php echo e(asset('assets/img/health/staff-11.webp')); ?>" alt="Dr. Victoria Torres" class="img-fluid">
                <div class="status-indicator available"></div>
              </div>
              <div class="doctor-details">
          ...
          <div class="doctor-profile" data-aos="zoom-in" data-aos-delay="600">
            <div class="profile-header">
              <div class="doctor-avatar">
                <img src="<?php echo e(asset('assets/img/health/staff-14.webp')); ?>" alt="Dr. Benjamin Lee" class="img-fluid">
                <div class="status-indicator available"></div>
              </div>
              <div class="doctor-details">
          ...
          <div class="row align-items-center">
            ...
            <div class="col-lg-6">
              <div class="content-wrapper" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="cta-wrapper">
                  <a href="/appointment" class="primary-cta">
            ...
            <div class="col-lg-6">
              <div class="image-container" data-aos="fade-left" data-aos-delay="300">
                <img src="<?php echo e(asset('assets/img/health/facilities-9.webp')); ?>" alt="Medical Excellence" class="img-fluid">
              </div>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-4">
              <div class="contact-actions" data-aos="fade-up" data-aos-delay="300">
                ...
                <a href="/contact" class="contact-link">Find Location</a>
              </div>
            </div>
      ...
      <div class="container">
        <div class="bottom-content" data-aos="fade-up" data-aos-delay="300">
          <div class="row align-items-center">
            ...
            <div class="col-lg-6">
              <div class="copyright">
                <p>© <span class="sitename">NaPotek</span>. All rights reserved.</p>
              </div>
            </div>
...
</html><?php /**PATH C:\xampp\htdocs\APOTEK_ONLINE\resources\views/fe/index.blade.php ENDPATH**/ ?>