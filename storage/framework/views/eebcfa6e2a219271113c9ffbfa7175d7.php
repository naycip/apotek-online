        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="<?php echo e(route('obat.index')); ?>" class="nav-item nav-link active"><i class="fa fa-medkit me-2"></i>Obat</a>
                </div>
            </nav>
        </div>
        <div class="content">
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="idjenis" class="form-select bg-dark text-white">
                                    ...
                                    <?php $__currentLoopData = $jenis_obats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($jo->id); ?>"><?php echo e($jo->jenis); ?></option>
                            ...
                            <a href="<?php echo e(route('obat.index')); ?>" class="btn btn-outline-light ms-2">Batal</a>
                            </form>
                        </div>
                    </div>
                </div>
...
</html><?php /**PATH C:\xampp\htdocs\APOTEK_ONLINE\resources\views\obat\create.blade.php ENDPATH**/ ?>